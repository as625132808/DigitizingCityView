        ...
        <el-tabs type="border-card" style="width: 100%;padding: 0px">
            ...
            <div class="data-event wait-data-event" :style="conHeight">
              <div class="data-event-list" v-loading="loading">
                <div class="data-event-list-item"
                     v-for="(item,index) of addEventList"
          ...
          <el-tab-pane>
            ...
            <div class="event-form history-data-event">
              <el-form>
                ...
                <el-form-item prop="eventParams.ObjName" style="margin-bottom: 5px;">
                  <el-col :span="10">
                  <el-input v-model="eventParams.remarks" clearable placeholder="关键字搜索" ></el-input>
                  </el-col>
                    <el-col :span="14">
                  <el-button type="primary" icon="el-icon-search" @click="onEventSearch()"
                             style="height: 28px;border-radius: 5px;padding: 0px 10px;margin-left:5px">查询
                  </el-button>
            ...
            <div class="data-event history-data-event" :style="contentHeight">
              ...
              <div class="data-event-list" v-loading="loading">
                <div class="data-event-list-item"
                     v-for="(item, index) of oldEventList"
                     :key="item.id"
                     :class="{yellowGround: changeYellow === index}"
                     @click="showDetails(index, item)">
    ...
    mounted() {
      ...
      window.addEventListener('resize', function() {
        vm.$nextTick(function() {
          ...
          vm.childrenHeight.height = (document.body.clientHeight - 50) + 'px';
          vm.contentHeight.height = (document.body.clientHeight - 215) + 'px';
          vm.conHeight.height = (document.body.clientHeight - 90) + 'px';
          vm.detailHeight.height = (document.body.clientHeight - 116) + 'px';
    ...
    methods: {
      ...
      showDetails(index, item, value) {
        ...
        if(Object.is(item.baidu_x,0) && Object.is(item.baidu_y,0)){
           ...
           this.IS_FLAG = true;
          this.$message({
            message: '该事件无坐标，请输入发生地点确定位置获取坐标',
            type: 'warning'
          });
